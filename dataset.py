...
class DealDataset(Dataset):
    def __init__(self, file_type: str):
        valid_record = pd.read_csv('data/' + file_type + '.txt', names=list("ABCDEFG"), sep='\t', on_bad_lines='skip')
    ...
    def __getitem__(self, index):
        return self.target_user[index], self.pos_item[index], self.pos_user[index], self.item_sample[index], self.user_sample[index]
